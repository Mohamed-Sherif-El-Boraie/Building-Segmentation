...
TILES_PER_ROW = 13
TILE_SIZE = 512
EDGE_THRESHOLD = 3  # pixels from edge to consider as "touching boundary"
...
def main():
    input_json = Path("data/annotated_data/_annotations.coco.json")
    output_json = Path("data/coco_json_annotations/merged_annotations.json")
