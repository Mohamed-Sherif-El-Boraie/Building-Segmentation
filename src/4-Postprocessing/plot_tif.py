...
def main():
    # Define paths
    json_path = "data/output/processed_buildings.json"
    tiff_path = "data/enhanced_data/enhanced_topographic.tif"
    output_path = "data/annotated_data/post_processed_buildings.tif"
